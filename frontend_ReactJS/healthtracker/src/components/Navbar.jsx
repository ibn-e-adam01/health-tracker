...
const Navbar = () => {
  ...
  return (
    ...
    <div className='w-full h-13 bg-[#CB2957] text-white flex items-center justify-between md:px-15 px-7 sticky top-0 z-50 shadow-md'>
        <Link className='hover:scale-95 hover:text-zinc-100 active:scale-95 active:text-zinc-100' to='/profile'><i className="fa-regular fa-circle-user text-3xl"></i></Link>
