  ...
  return (
    ...
    <div className='h-auto w-full bg-zinc-900 flex justify-center items-center flex-col'>
        ...
        <div className='w-full h-190 flex flex-col gap-4 justify-start pt-5 items-center bg-zinc-900'>
            ...
            <div key={bmiUser._id} className='bg-zinc-800 w-61 md:w-auto h-auto rounded-md mt-3 text-zinc-100 flex flex-col justify-center items-start gap-2 px-9 py-5'>
                <div className='flex gap-2 items-center justify-center overflow-hidden'>
                <h1 className='text-lg font-bold'>BMI: </h1><h1 className='text-lg font-bold'>{bmiUser.bmi}</h1>
                </div>
                <div className='flex gap-2 items-center justify-center overflow-hidden'>
                <h1 className='text-lg font-bold'>Category: </h1><h1 className='text-lg'>{bmiUser.category}</h1>
                </div>
            </div>
            ))} {BMI?.length == 0 && <div className='w-full flex items-center justify-center mt-9'><p className='text-zinc-400'>No Record Yet.</p></div>}
